...
One folder per feature: `project/specs/<feature>/`.
...
Both land by pull request at a human-reviewable gate. Decision records for a feature go in [`../adr/`](../adr/); the generated requirement→test tables go in [`../traceability/`](../traceability/).
