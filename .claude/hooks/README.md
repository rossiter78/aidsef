...
2. **The project-wide hook** in [settings.json](../settings.json) reads the `AIDSEF_ROLE` environment variable — covers headless local-model runs, which set it (see `/aidsef-4-build`).
